...
describe Game do
  ...
  it 'should return true once win conditions are met' do
    # Top row win X
    subject.game_board.board_spaces = {"7": "X", "8": "X", "9": "X", "4": "O", "5": "X", "6": "O", "1": "X", "2": "X", "3": "O"}
    expect(subject.check_win_condition).to be_truthy

    # Middle column win O
    subject.game_board.board_spaces = {"7": "X", "8": "O", "9": "X", "4": "O", "5": "O", "6": "X", "1": "X", "2": "O", "3": "O"}
    expect(subject.check_win_condition).to be_truthy

    # Non-win check
    subject.game_board.board_spaces = {"7": " ", "8": "O", "9": "X", "4": " ", "5": "O", "6": "X", "1": " ", "2": " ", "3": " "}
