...
describe Board do
  ...
  expect(subject.board_spaces).to eq({:"7"=>" ", :"8"=>" ", :"9"=>" ", :"4"=>" ", :"5"=>" ", :"6"=>" ", :"1"=>" ", :"2"=>" ", :"3"=>" "})
  end
...
context Board do
  it 'should return true on board_full?' do
    subject.board_spaces = {"7"=> "X", "8"=>"X", "9"=>"O", "4"=>"O", "5"=>"X", "6"=>"O", "1"=>"X", "2"=>"X", "3"=>"O"}
...
context Board do
  it 'should return false on unoccupied space' do
    subject.board_spaces = {"7"=> " ", "8"=>"X", "9"=>"O", "4"=>"O", "5"=>"X", "6"=>"O", "1"=>"X", "2"=>"X", "3"=>"O"}
